...
get the app created:
    ...
    $ heroku apps:create clojure-getting-started
    Creating clojure-getting-started... done, stack is cedar
    http://clojure-getting-started.herokuapp.com/ | git@heroku.com:clojure-getting-started.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://clojure-getting-started.herokuapp.com deployed to Heroku

    To git@heroku.com:clojure-getting-started.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://clojure-getting-started.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@clojure-getting-started.herokuapp.com/repl
